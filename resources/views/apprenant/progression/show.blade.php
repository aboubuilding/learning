...
@section('title', 'Détail de la progression — AquaForm')
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <span class="fw-bold fs-4">{{ $formation['progression'] }}%</span>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="fw-bold">{{ $formation['temps_passe'] }} / {{ $formation['duree_totale'] }}</div>
                        </div>
                        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <div class="card shadow-sm border-0 mt-4">
                <div class="card-body text-center">
                    <i class="fas fa-certificate fa-3x text-success opacity-50"></i>
                    <h6 class="fw-bold mt-2">Certificat</h6>
                    <p class="text-muted small">
                        {{ $formation['progression'] == 100 ? 'Certificat disponible' : 'Terminez la formation pour obtenir le certificat' }}
                    </p>
                    ...
                    @else
                        <span class="badge bg-secondary">En attente de complétion</span>
                    @endif
                </div>
            </div>
        </div>
